...
# ==============================================================================
                ...
                for g in the_guys:
                    ...
                    content = json.dumps({"action": "exchange", "message": msg["message"], "from": from_name})
                    mysend(to_sock, content)
                    # ---- end of your code --- #
...
# ==============================================================================
                ...
                # ---- start your code ---- #
                from_name = self.logged_sock2name[from_sock]
                print(from_name + ' asks for poem ' + msg['target'])
...
# ==============================================================================
                ...
                from_name = self.logged_sock2name[from_sock]
                content = msg["target"]
                print(from_name + ' search for term ' + content)
                search_rslt = '\n'.join([str(i) for i in self.indices[from_name].search(content)])
                # ---- end of your code --- #
                mysend(from_sock, json.dumps(
